...
#include "Mrt_swath_prm_file.h"
#include <boost/filesystem.hpp>


modis_api::Mrt_swath_prm_file::~Mrt_swath_prm_file()
{
}

string modis_api::Mrt_swath_prm_file::get_prm_file_content()
{
...
void modis_api::Mrt_swath_prm_file::export_prm_file(const string& dest)
{
